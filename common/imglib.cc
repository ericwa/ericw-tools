...
namespace img
{
    ...
    */
    struct pcx_t
    {
        ...
        auto stream_data()
        {
            return std::tie(manufacturer, version, encoding, bits_per_pixel, xmin, ymin, xmax, ymax, hres, vres, palette_reserved, color_planes, bytes_per_line, palette_type, filler);
        }
    };
    ...
    */
    struct q2_miptex_t
    {
        ...
        auto stream_data()
        {
            return std::tie(name, width, height, offsets, animname, flags, contents, value);
        }
    };
    ...
    */
    struct targa_t
    {
        ...
        auto stream_data()
        {
            return std::tie(id_length, colormap_type, image_type, colormap_index, colormap_length, colormap_size, x_origin, y_origin, width, height, pixel_size, attributes);
        }
    };
