...
public:
    ...
    octree_node_t(const aabb3f &box, const int depth) : m_depth(depth), m_bbox(box), m_leafNode(true), m_leafObjects()
    {
...
public:
    void insert(const aabb3f &objBox, const T &obj) { insert(0, objBox, obj); }
