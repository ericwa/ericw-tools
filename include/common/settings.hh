...
public:
    ...
    inline setting_error setSetting(const std::string &name, const std::string &value, bool locked)
    {
        ...
        parser_t p{value};
        return setting->parse(name, p, locked) ? setting_error::NONE : setting_error::INVALID;
    }
