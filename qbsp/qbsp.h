...
enum {BSPENT, BSPPLANE, BSPTEX, BSPVERTEX, BSPVIS, BSPNODE, BSPTEXINFO, BSPFACE, 
	  BSPLIGHT, BSPCLIPNODE, BSPLEAF, BSPMARKSURF, BSPEDGE, BSPSURFEDGE, BSPMODEL,
	  MAPFACE, MAPBRUSH, MAPENTITY, WINDING, FACE, PLANE, PORTAL, SURFACE, NODE,
	  BRUSH, MIPTEX, WVERT, WEDGE, HASHVERT, OTHER, GLOBAL};
#define BSP_LUMPS	15
